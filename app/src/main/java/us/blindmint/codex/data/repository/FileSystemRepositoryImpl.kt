...
import us.blindmint.codex.domain.library.book.NullableBook.NotNull
import us.blindmint.codex.domain.library.book.NullableBook.Null
...
class FileSystemRepositoryImpl @Inject constructor(
     ...
     */
    override suspend fun getBookFromFile(cachedFile: CachedFile, loadCover: Boolean): NullableBook {
        val parsedBook = fileParser.parse(cachedFile, loadCover)
        if (parsedBook == null) {
