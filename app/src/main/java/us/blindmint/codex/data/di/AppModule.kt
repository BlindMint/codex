    ...
    fun provideBookDao(app: Application): BookDao {
        ...
        return Room.databaseBuilder(
            ...
            .addMigrations(
                ...
                DatabaseHelper.MIGRATION_14_15, // adds OPDS/metadata/comic fields, OpdsSourceEntity table
                DatabaseHelper.MIGRATION_15_16, // adds status to OpdsSourceEntity
                DatabaseHelper.MIGRATION_16_17, // adds isFavorite to BookEntity
