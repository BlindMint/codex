    ...
    if (book.isComic) {
        ...
        Column(Modifier.fillMaxSize()) {
            ComicReaderLayout(
                ...
                comicZoomStart = mainState.value.comicZoomStart,
                comicCropBorders = mainState.value.comicCropBorders,
                comicLandscapeZoom = mainState.value.comicLandscapeZoom,
                comicProgressBar = mainState.value.comicProgressBar,
                comicProgressBarPadding = mainState.value.comicProgressBarPadding,
                comicProgressBarAlignment = mainState.value.comicProgressBarAlignment,
                comicProgressBarFontSize = mainState.value.comicProgressBarFontSize,
