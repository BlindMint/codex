...
object DataStoreConstants {
    ...
    val SHOW_SEARCH_SCROLLBAR = booleanPreferencesKey("show_search_scrollbar")
    ...
    val LIBRARY_LIST_SIZE = intPreferencesKey("library_list_size")
    ...
    val COMIC_CUSTOM_BACKGROUND_COLOR = stringPreferencesKey("comic_custom_background_color")
    val COMIC_VOLUME_KEYS_ENABLED = booleanPreferencesKey("comic_volume_keys_enabled")
    val COMIC_VOLUME_KEYS_INVERTED = booleanPreferencesKey("comic_volume_keys_inverted")

    // Speed Reader settings
    val SPEED_READING_WPM = intPreferencesKey("speed_reading_wpm")
    val SPEED_READING_MANUAL_SENTENCE_PAUSE_ENABLED = booleanPreferencesKey("speed_reading_manual_sentence_pause_enabled")
    val SPEED_READING_SENTENCE_PAUSE_DURATION = intPreferencesKey("speed_reading_sentence_pause_duration")
    val SPEED_READING_OSD_ENABLED = booleanPreferencesKey("speed_reading_osd_enabled")
    val SPEED_READING_WORD_SIZE = intPreferencesKey("speed_reading_word_size")
    val SPEED_READING_ACCENT_CHARACTER_ENABLED = booleanPreferencesKey("speed_reading_accent_character_enabled")
    val SPEED_READING_ACCENT_COLOR = stringPreferencesKey("speed_reading_accent_color_v2")
    val SPEED_READING_ACCENT_OPACITY = doublePreferencesKey("speed_reading_accent_opacity")
    val SPEED_READING_SHOW_VERTICAL_INDICATORS = booleanPreferencesKey("speed_reading_show_vertical_indicators")
    val SPEED_READING_VERTICAL_INDICATORS_SIZE = intPreferencesKey("speed_reading_vertical_indicators_size")
    val SPEED_READING_VERTICAL_INDICATOR_TYPE = stringPreferencesKey("speed_reading_vertical_indicator_type")
    val SPEED_READING_SHOW_HORIZONTAL_BARS = booleanPreferencesKey("speed_reading_show_horizontal_bars")
    val SPEED_READING_HORIZONTAL_BARS_THICKNESS = intPreferencesKey("speed_reading_horizontal_bars_thickness")
    val SPEED_READING_HORIZONTAL_BARS_LENGTH = doublePreferencesKey("speed_reading_horizontal_bars_length")
    val SPEED_READING_HORIZONTAL_BARS_DISTANCE = intPreferencesKey("speed_reading_horizontal_bars_distance")
    val SPEED_READING_HORIZONTAL_BARS_COLOR = stringPreferencesKey("speed_reading_horizontal_bars_color_v2")
    val SPEED_READING_HORIZONTAL_BARS_OPACITY = doublePreferencesKey("speed_reading_horizontal_bars_opacity")
