...
object DataStoreConstants {
    ...
    val SPEED_READING_ACCENT_COLOR = stringPreferencesKey("speed_reading_accent_color")
    ...
    val SPEED_READING_HORIZONTAL_BARS_COLOR = stringPreferencesKey("speed_reading_horizontal_bars_color")
